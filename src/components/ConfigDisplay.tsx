 ...
 */
export const ConfigDisplay = (): ReactElement => (
  <div className="space-y-4">
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>Configured via Terraform and GitHub Actions</CardDescription>
      </CardHeader>
      <CardContent>
...
const ConfigSection = ({ title, items }: IConfigSectionProps): ReactElement => (
